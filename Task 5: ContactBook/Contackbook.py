...
root = Tk()
root.title("Professional Phonebook")
...
# Header Label
Label(root, text="PHONEBOOK", font=("Arial", 18, "bold"), bg="#007BFF", fg="white").pack(fill=X)

# Frame for Listbox
list_frame = Frame(root, bg="#F4F4F4")
list_frame.pack(side=LEFT, padx=20, pady=20)

listboxname = Listbox(list_frame, width=30, height=12, font=("Arial", 14), bg="white", fg="black", 
                      highlightthickness=1, cursor="hand2", selectbackground="#007BFF")
listboxname.pack(side=LEFT, fill=BOTH)
...
Button(button_frame, text="ADD", width=btn_width, bg=btn_color, fg=btn_fg, font=btn_font, command=addpop).pack(pady=5)
Button(button_frame, text="VIEW", width=btn_width, bg=btn_color, fg=btn_fg, font=btn_font, command=view).pack(pady=5)
Button(button_frame, text="UPDATE", width=btn_width, bg=btn_color, fg=btn_fg, font=btn_font, command=update).pack(pady=5)
Button(button_frame, text="REMOVE", width=btn_width, bg=btn_color, fg=btn_fg, font=btn_font, command=remove).pack(pady=5)
Button(button_frame, text="FIND", width=btn_width, bg=btn_color, fg=btn_fg, font=btn_font, command=find).pack(pady=5)
